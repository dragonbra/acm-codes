...
def interact(pstr1, pstr2, name1='A', name2='B', fobj1=None, fobj2=None):
    pargs1 = shlex.split(pstr1,posix=posix)
    pargs2 = shlex.split(pstr2,posix=posix)
    a_to_b = logged_pipe(name1, fobj1)
    b_to_a = logged_pipe(name2, fobj2)
...
def main():
    ...
    parser.add_argument('-v', '--verbose', action='store_true', default=False,
                        help="print output from processes")
    ...
    fobj = sys.stdout if args.verbose  else None

    interact(args.proc1, args.proc2, args.name1, args.name2, fobj,fobj)
